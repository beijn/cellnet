...
export HPC_SCC_ARGS="--cpus-per-task=8 --mem=40G --partition=scc-gpu -G A100"	
export HPC_SCC_LIVE="srun $HPC_SCC_ARGS -C inet --partition=jupyter -G V100 --time 6:00:00"
